...
webpackJsonp([31], {
  ...
  30: function (e, a, t) {
    var r = t(4), s = React.createClass({
        ...
        render: function () {
          ...
          if (this.props.urlData && (this.props.urlData.page && delete this.props.urlData.page, a = '?' + r.parseParam(this.props.urlData) + '&page='), t.totalPage < 8 && t.totalPage != 1) {
            for (var i = 1; i <= t.totalPage; i++) {
              t.pageCurrent == i ? e.push(React.createElement('a', {
                key: i,
                href: a + i,
          ...
          } else if (t.totalPage >= 8) {
            e.push(React.createElement('a', {
              key: '0',
              href: a + '1',
              className: 'ipg',
              'data-id': '1'
            }, '首页')), t.pageCurrent != 1 && e.push(React.createElement('a', {
              key: '-1',
  ...
  75: function (e, a, t) {
    ...
    o.tid1 = o.tid1 ? o.tid1 : '', o.tid2 = o.tid2 ? o.tid2 : '', $('.classify ').delegate('a', 'click', function () {
      ...
      if (e == 'cate1') {
        var a = $(this).attr('tid')
        $('#c' + a).addClass('active').siblings().removeClass('active'), o.tid1 = a || '', o.tid2 = ''
      } else {
        var a = $(this).attr('tid')
        o.tid2 = a || '', o.tid1 = $('#cate1 .active>a').attr('tid')
      }
        ...
        _dealWithData: function (e) {
          function a (e) {
            var a = e.map(function (e, a) {
              var t
              return t = e.isFree == 0 ? '免费' : e.fabPrice >= 2e6 ? '面议' : e.fabPrice, React.createElement('li', {className: 'course_item'}, React.createElement('a', {
